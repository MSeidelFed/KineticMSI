...
#' @param MeasurementFileDir directory where the input files are stored. Defaults to KineticMSI external data folder where exemplary files are stored.
#' @param pattern defaults to "repx.csv" as in the exemplary KineticMSI files. It is used to define the pattern on which input files are looked for in the MeasurementFileDir.
...
rmNullPixel <- function(MeasurementFileDir = system.file("extdata", package = "KineticMSI"),
                        pattern = "rep.\\.csv",
                        SubSetReps = FALSE,
                        csvReturn = TRUE,
