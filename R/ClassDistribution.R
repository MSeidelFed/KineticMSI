...
#' @param PlotMain defaults to NULL. When defined as a charachter vector it will appear as the diagnostic plots main title. 
...
ClassDistribution <- function(inMat,
  ...
  if(plots == T) {
    ...
    suppressMessages(print(ggplot(mydata4.4, aes(x = as.numeric(value), y = X1_1, color = out_vec)) + 
    ...
    suppressMessages(print(ggplot(mydata4.4, aes(x = as.numeric(value), fill = X1_1, color = out_vec)) +
